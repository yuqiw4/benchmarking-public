...
- Geometric mean: 1.03x slower (HPT: reliability of 99.81%, 1.01x slower at 99th %ile)
- Memory usage: unknown
...
- [📈time plot](bm-20240427-pythonperf1-amd64-python-51aefc5bf907ddffaaf0-3.13.0a6%2B-51aefc5-vs-base.svg)
...
- [📈time plot](bm-20240427-pythonperf1_win32-x86-python-51aefc5bf907ddffaaf0-3.13.0a6%2B-51aefc5-vs-base.svg)
...
- Geometric mean: 1.05x slower (HPT: reliability of 99.95%, 1.01x slower at 99th %ile)
- Memory usage: 1.05x
- missing benchmarks: sqlalchemy_declarative, sqlalchemy_imperative, unpack_sequence
...
- Memory usage: 1.01x
- [🧠memory plot](bm-20240427-darwin-arm64-python-51aefc5bf907ddffaaf0-3.13.0a6%2B-51aefc5-vs-base-mem.svg)
- [📄table](bm-20240427-darwin-arm64-python-51aefc5bf907ddffaaf0-3.13.0a6%2B-51aefc5-vs-base.md)
- [📈time plot](bm-20240427-darwin-arm64-python-51aefc5bf907ddffaaf0-3.13.0a6%2B-51aefc5-vs-base.svg)
