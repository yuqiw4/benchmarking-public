...
| async_tree_eager_tg              | 41.4 ms                                                    | 43.2 ms: 1.04x slower                                                  |
...
Benchmark hidden because not significant (9): async_tree_io_tg, async_tree_cpu_io_mixed, async_tree_eager_io_tg, async_tree_none_tg, async_tree_memoization, async_tree_cpu_io_mixed_tg, async_tree_io, async_tree_eager_io, async_tree_eager_memoization
...
| regex_compile  | 68.5 ms                                                    | 85.7 ms: 1.25x slower                                                  |
| Geometric mean | (ref)                                                      | 1.06x slower                                                           |
...
| pycparser                        | 632 ms                                                     | 659 ms: 1.04x slower                                                   |
...
| mypy2                            | 379 ms                                                     | 407 ms: 1.07x slower                                                   |
| async_tree_eager                 | 60.3 ms                                                    | 64.8 ms: 1.07x slower                                                  |
...
| sympy_sum                        | 69.2 ms                                                    | 76.2 ms: 1.10x slower                                                  |
...
| spectral_norm                    | 66.4 ms                                                    | 74.1 ms: 1.12x slower                                                  |
| generators                       | 22.9 ms                                                    | 25.8 ms: 1.13x slower                                                  |
...
Benchmark hidden because not significant (16): async_tree_io_tg, async_tree_cpu_io_mixed, async_tree_eager_io_tg, async_tree_none_tg, xml_etree_parse, create_gc_cycles, pickle_list, dask, asyncio_websockets, telco, json_loads, async_tree_memoization, async_tree_cpu_io_mixed_tg, async_tree_io, async_tree_eager_io, async_tree_eager_memoization
