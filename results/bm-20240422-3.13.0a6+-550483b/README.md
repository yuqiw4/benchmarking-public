...
- Geometric mean: 1.01x faster (HPT: reliability of 94.09%, 1.00x faster at 99th %ile)
- Memory usage: 0.92x
- missing benchmarks: sqlalchemy_declarative, sqlalchemy_imperative, unpack_sequence
...
- Geometric mean: 1.02x faster (HPT: reliability of 99.32%, 1.00x faster at 99th %ile)
- Memory usage: 0.98x
- missing benchmarks: bpe_tokeniser, flaskblogging
...
- Geometric mean: 1.01x faster (HPT: reliability of 98.01%, 1.00x faster at 99th %ile)
- Memory usage: unknown
- missing benchmarks: flaskblogging
